            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://SharpWear.com/" className="flex items-center">
                            <img src="src\assets\images\13-04.jpg" className="h-16 w-16 rounded-full border-black border-2" alt="SharpWear Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SharpWear</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://SharpWear.com/" className="hover:underline">Sharp Wear</a>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="https://github.com/themesberg/SharpWear" className="hover:underline ">Github</a>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://SharpWear.com/" className="hover:underline">SharpWear™</a>. All Rights Reserved.
                    </span>
