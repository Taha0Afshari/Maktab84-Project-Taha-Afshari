    ...
    return (
        <>
            <footer className="bg-[#222222]">
                <div className="mx-16  sm:p-6 dark:bg-gray-900">
                    <div className="md:flex md:justify-between flex flex-col ">
                        <div className="my-6 md:mb-0 flex flex-wrap justify-between items-center">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-[#919091]">ما به شما تمامی اخبار حراجی و رویدادها را اطلاع رسانی می کنیم</span>
                            </div>
                            <div className="m-2">
                                <input placeholder="ایمیل خود را وارد کنید" className="bg-[#2c2c2c] py-2 px-5"></input>
                                <button className="bg-black text-white text-[1rem] py-2 px-4 mr-2">مشترک شوید</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-white dark:text-gray-400">
                                ...
                                <li className="mb-4 text-[#999999]">
                                    <a href="https://tailwindcss.com/" className="hover:underline">ادرس</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="text-white dark:text-gray-400">
                                ...
                                <li className="mb-4 text-[#999999]">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">سوالات متداول</a>
                                </li>
                                <li className="mb-4 text-[#999999]">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">السی مگ</a>
                                </li>
                                <li className="mb-4 text-[#999999]">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">کاتالوگ دیجیتال السی من</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-[#cccccc] uppercase dark:text-white">مشتریان</h2>
                            <ul className="text-white dark:text-gray-400">
                                <li className="mb-4 text-[#999999] flex flex-wrap">
                                    <a href="#" className="hover:underline">باشگاه مشتریان</a>
                                </li>
                                <li className="mb-4 text-[#999999]">
                                    <a href="#" className="hover:underline">کارت هدیه</a>
                                </li>
                                <li className="mb-4 text-[#999999]">
                                    <a href="#" className="hover:underline">قوانین سایت</a>
                                </li>
                                <li className="mb-4 text-[#999999]">
                                    <a href="#" className="hover:underline">رویه ارسال کالا</a>
                                </li>
                                <li className="mb-4 text-[#999999]">
                                    <a href="#" className="hover:underline">فروشگاه های ال سی من</a>
                                </li>
                            </ul>
                        </div>
